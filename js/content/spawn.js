...
const startHere = {
  ...
  sections: {
    ...
    whyThis:
      "A CV is a list of claims. It has no room for the argument behind them.\n\nSo every project here follows the same shape — **Problem, Build, Decisions, Learnings** — and the two sections a CV can never contain are the last two. That's where the trade-offs I'd defend live, and the things that changed my mind.\n\nIf you want the short test of whether that's genuine, read the research up in the Knowledge Garden. All three pieces state their own limits: a dataset cut from 10,171 rows to 1,526, a positive thesis result taken apart by its own author, and a framework whose abstract says it isn't validated yet. That habit is the thing I'd most want you to take away.",
    controls:
